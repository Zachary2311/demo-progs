...
2. Copy `.env.example` to `.env` and fill in the required values:
  ...
  | `X_API_BEARER` | Recommended bearer token for the official X API v2; falls back to `TWITTER_BEARER_TOKEN` if unset |
